...
function resetFpsUnlock() {
    _wasOn2 = false;
    _restoreFps();
    logInfo("fpsunlock reset", { target: _readTarget2() });
}
  ...
  var APK_FEATURES = Object.freeze([
    Object.freeze({ key: "aimbot", label: "Aimbot" }),
    Object.freeze({ key: "autododge", label: "Auto Dodge" }),
    Object.freeze({ key: "esp", label: "ESP" }),
    Object.freeze({ key: "spinner", label: "Spinner" }),
    Object.freeze({ key: "killaura", label: "Kill Aura" }),
    Object.freeze({ key: "camera", label: "Camera" }),
    Object.freeze({ key: "spray", label: "Spam Spray" }),
    Object.freeze({ key: "pin", label: "Empty Pin" }),
    Object.freeze({ key: "brawltv", label: "BrawlTV" }),
    Object.freeze({ key: "spec", label: "Spectators" }),
    Object.freeze({ key: "chatspam", label: "Chat Spam" }),
    Object.freeze({ key: "fps", label: "FPS" }),
    Object.freeze({ key: "fpsunlock", label: "FPS Unlock" }),  // <-- added
    Object.freeze({ key: "gradient", label: "Gradient" }),
    Object.freeze({ key: "speedhack", label: "Speedhack" })
    // holdshoot removed
]);
  ...
  var TICK_FEATURES = new Set(["aimbot", "autododge", "killaura", "esp", "spray", "pin", "spinner", "speedhack"]);
// holdshoot removed
  var FEATURE_NAMES = [
    "aimbot",
    "autododge",
  ...
  function ensureRuntime() {
    if (!runtimePromise) {
      runtimePromise = ensureBase().then(() => {
        ...
        setChatSpamOptions({
          message: "made by @4hypeless txktok"
        });
        return true;
      }).catch(() => false);
    }
